<template>
  <div
    class="flex flex-col justify-center items-center text-sm md:text-base p-4"
  >
    <div
    ...
    >
      ...
      <div class="w-8/12">
        ...
        >
          ...
          <UButton block type="submit" color="amber" :loading="pending">
            ارسل لنا
          </UButton>
        </UForm>
      </div>
      <div class="flex flex-col md:flex-row">
        <div class="flex flex-col p-2 gap-2">
          ...
          <p class="">
            <span class="text-amber-500"> الهاتف </span>
            : 0507583933
            <br />
            <span class="text-amber-500"> البريد الإلكتروني </span>
        ...
        <div class="flex flex-col p-2 gap-2">
          ...
          <p class="">
            ...
            <br />
            خلال 24 ساعة للرد على الطلبات والاستفسارات والشكاوي
          </p>
        </div>
      </div>
    </div>
